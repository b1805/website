                      ...
                      <div className="grid flex-1 auto-cols-fr grid-cols-1 gap-x-8 gap-y-6 py-4 md:grid-cols-3 md:gap-y-0 md:py-8 lg:pr-8">
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Latest Findings</h5>
                              <p className="hidden text-sm md:block">
                                Discover our recent research breakthroughs.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Learn about our current research initiatives.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Meet the experts driving our research.
                              </p>
                            </div>
                          </a>
                          <a
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Data Sets</h5>
                              <p className="hidden text-sm md:block">
                                Access our comprehensive data collections.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Research Tools</h5>
                              <p className="hidden text-sm md:block">
                                Utilize our tools for effective research.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Events Calendar</h5>
                              <p className="hidden text-sm md:block">
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Insights from our latest research articles.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                In-depth analysis of our research projects.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Key findings from our recent studies.
                              </p>
                            </div>
                          </a>
                        </div>
                          ...
                          <div className="grid w-full max-w-none grid-cols-1 grid-rows-[auto_auto_auto_auto] items-start gap-y-2 md:block">
                            <a href="#" className="flex flex-col py-2">
                              ...
                              <div className="mt-2 flex max-w-[18rem] flex-col justify-start md:mt-0">
                                ...
                                <p className="text-sm">
                                  Explore groundbreaking research topics.
                                </p>
                                <div className="mt-2">
                                  <Button
                                    title="Read More"
