      ...
      <div className="container">
        <div className="mx-auto w-full max-w-lg text-center">
          ...
          <blockquote className="text-xl font-bold md:text-2xl">
            "Working with I-DEEL has transformed our understanding of ecological
            dynamics. Their innovative approach and collaborative spirit are
            truly inspiring."
          </blockquote>
