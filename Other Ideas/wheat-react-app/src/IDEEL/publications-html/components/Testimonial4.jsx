      ...
      <div className="container">
        <div className="mx-auto w-full max-w-lg text-center">
          ...
          <blockquote className="text-xl font-bold md:text-2xl">
            "The research conducted at I-DEEL has significantly advanced our
            understanding of ecological dynamics and evolutionary processes.
            Collaborating with this team has been a transformative experience
