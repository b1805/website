        ...
        <div className="grid w-full auto-cols-fr grid-cols-1 items-center justify-center gap-12 md:grid-cols-2 md:gap-10 lg:gap-x-20">
          ...
          <div className="flex flex-col items-start">
            ...
            <blockquote className="text-xl font-bold md:text-2xl">
              "The publications from COSSEE have profoundly shaped my
              understanding of ecological interactions and have been pivotal in
              advancing my research. Their rigorous approach and innovative
              findings consistently inspire the scientific community."
            </blockquote>
            <div className="mt-6 flex flex-nowrap items-center gap-5 md:mt-8">
              <div>
                <p className="font-semibold">Dr. Emily Chen</p>
                <p>Ecologist, University of Toronto</p>
              </div>
